                  ...
                  <v-list-item three-line  class="mt-10">
                    <v-list-item-content>
                      <div class="mb-4">
                          ...
                          <v-icon  x-large :color="active ? 'white' : '#A4BEF3'">fas fa-chart-bar</v-icon>
                  ...
                  <v-list-item three-line  class="mt-10">
                    <v-list-item-content>
                      <div class="mb-4">
                          ...
                          <v-icon  x-large :color="active ? 'white' : '#A4BEF3'">far fa-user</v-icon>
                  ...
                  <v-list-item three-line  class="mt-10">
                    <v-list-item-content>
                      <div class="mb-4">
                          ...
                          <v-icon  x-large :color="active ? 'white' : '#A4BEF3'">fas fa-suitcase</v-icon>
                  ...
                  <v-list-item three-line  class="mt-10">
                    <v-list-item-content>
                      <div class="mb-4">
                          ...
                          <v-icon  x-large :color="active ? 'white' : '#A4BEF3'">fas fa-search</v-icon>
                  ...
                  <v-list-item three-line  class="mt-10">
                    <v-list-item-content>
                      <div class="mb-4">
                          ...
                          <v-icon  x-large :color="active ? 'white' : '#A4BEF3'">fas fa-globe-africa  </v-icon>
